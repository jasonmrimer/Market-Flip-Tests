...
/**
 * The purpose of this test case is to test the connections for the Notifications Data Access
 * Object. It connects to the database as well as the other classes that require use of the
 * Notifications DAO for integration testing.
 *
 * @author highball
 *
 */
public class JIT_MF_NotificationsDAO {
	...
	/**
	 * The purpose of this test is to create the standard Notifications table then see if it exists
	 * by
